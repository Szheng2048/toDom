...
*/
let inputArea = document.querySelector(".todo-input")
document.querySelector(".add-todo").addEventListener("click",()=>{
  ...
  addItemToToDoList(newThingToDo)
  printTodo(newThingToDo)
  inputArea.value = ""
})
